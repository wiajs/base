...
$$1.isObject = v => $$1.type(v) === 'object';
$$1.isMap = v => $$1.type(v) === 'Map';
$$1.isSet = v => $$1.type(v) === 'Set';
$$1.isRegExp = v => $$1.type(v) === 'RegExp';
$$1.isSymbol = v => $$1.type(v) === 'symbol';
$$1.isObj = $$1.isObject;
$$1.isPromise = val =>
  ($$1.isObject(val) || $$1.isFunction(val)) && $$1.isFunction(val.then) && $$1.isFunction(val.catch);
...
$$1.isNum = $$1.isNumeric;
$$1.isString = v => $$1.type(v) === 'string';
$$1.isStr = $$1.isString;
$$1.isDom = v => D.isD(v);
$$1.isDate = v => $$1.type(v) === 'date';
...
$$1.fastLink = function (ctx) {
  ...
  try {
    const links = $$1.qus('a[fastLink][fastlink][back]', ctx);
    links.forEach(link => {
      if ($$1.support.touch) {
        let startX;
        let startY;
